 ...
 */
final class Version20210118012319 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE wallet ADD id_user_id INT NOT NULL, DROP draw_bet, DROP with_add_earnings');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE wallet ADD draw_bet INT DEFAULT NULL, ADD with_add_earnings INT DEFAULT NULL, DROP id_user_id');
    }
}
